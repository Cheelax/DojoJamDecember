...
COMPONENTS=("Player" "EntityLifeStatus" "EntityAtPosition" "PlayerScore" "Map" "Tile" "Type" "Game" "TileAtPosition" "PlayerInventory" "PlayerCoins")
...
# Initialize ERC20
sozo execute $LORDS_ADDRESS initializer --calldata $WORLD_ADDRESS,0x4c4f524453,0x4c4f524453,0x0,0x100000,0x517ececd29116499f4a1b64b094da79ba08dfd54a3edaa316134c41f8160973
